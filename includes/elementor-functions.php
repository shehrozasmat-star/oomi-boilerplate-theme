...
/**
 * Add Ni Elementor theme Header & Footer to Experiments.
 */
add_action( 'elementor/experiments/default-features-registered', function( \Elementor\Core\Experiments\Manager $experiments_manager ) {
	$experiments_manager->add_feature( [
		...
		'tag' => esc_html__( 'Ni Theme', 'hello-elementor' ),
		'description' => sprintf(
			'%1$s <a href="%2$s" target="_blank">%3$s</a>',
			esc_html__( 'Customize and style the builtin Ni Theme’s cross-site header & footer from the Elementor "Site Settings" panel.', 'hello-elementor' ),
