...
function hello_elementor_fail_load_admin_notice() {
	...
	$message = esc_html__( 'The Ni Theme is a lightweight starter theme that works perfectly with the Elementor award-winning site builder plugin.', 'hello-elementor' );
	...
	<div class="notice updated is-dismissible hello-elementor-notice hello-elementor-install-elementor">
		...
		<div class="hello-elementor-notice-content">
			<h3><?php echo esc_html__( 'Thanks for installing the Ni Theme!', 'hello-elementor' ); ?></h3>
